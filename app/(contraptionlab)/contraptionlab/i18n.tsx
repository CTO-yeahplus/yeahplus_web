...
// 한/영 토글. 본문은 두 언어를 모두 담고 CSS 로 한쪽만 보여주므로
// 여기서는 <html data-lang> 값만 관리한다 (sillok·steelstorm 과 같은 구조).
import { createContext, useContext, useEffect, useState } from 'react';

export type Lang = 'ko' | 'en';

export const STORAGE_KEY = 'contraptionlab.site.lang';

export const NAV = {
  ko: { home: '홈', how: '어떻게 노나', labs: '실험실', support: '지원', privacy: '개인정보', terms: '약관' },
  en: { home: 'Home', how: 'How it plays', labs: 'The labs', support: 'Support', privacy: 'Privacy', terms: 'Terms' },
} as const;

/** 공개 문의 창구. cto@ 는 개인 주소라 문서에 싣지 않는다. */
