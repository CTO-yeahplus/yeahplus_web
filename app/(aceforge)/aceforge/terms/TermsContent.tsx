      ...
      <article className="af-doc">
        ...
        {ko ? (
          <>
            ...
            <p>1. Aceforge(에이스포지)는 YeahPlus Co., Ltd.가 개발·배포하는 1회 구매형 오프라인 싱글플레이 게임입니다.</p>
            <p>
              2. 본 앱은 광고와 인앱결제를 포함하지 않으며, 어떠한 개인정보도 수집하지 않습니다 (
              <Link href="/aceforge/privacy">개인정보 처리방침</Link> 참조).
            </p>
          ...
          <>
            ...
            <p>1. Aceforge is a pay-once, offline, single-player game developed and published by YeahPlus Co., Ltd.</p>
            <p>
              2. The app contains no advertising and no in-app purchases, and collects no personal data (see the{' '}
              <Link href="/aceforge/privacy">Privacy Policy</Link>).
            </p>
