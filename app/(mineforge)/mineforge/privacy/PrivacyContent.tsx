...
const KO = (
  <>
    <div className="mf-card">
      <p className="mf-big">마인포지는 어떠한 개인정보도 수집하지 않습니다.</p>
    ...
    <h3>1. 수집하는 정보</h3>
    <p>
      없습니다. 마인포지는 이름, 이메일, 전화번호, 위치, 연락처, 사진, 기기 식별자 등{' '}
      <strong>어떤 종류의 개인정보도 수집·저장·전송하지 않습니다.</strong>
    </p>

    <h3>2. 게임 저장 데이터</h3>
    <p>
      진행 상황(현재 도전, 보유한 참, 배낭 구성, 최고 기록, 소리·언어 설정)은{' '}
    ...
    <p>
      마인포지는 인터넷에 연결하지 않습니다. 광고 네트워크, 분석 도구(애널리틱스), 크래시 리포팅, 소셜
...
const EN = (
  <>
    <div className="mf-card">
      <p className="mf-big">Mineforge collects no personal data. None.</p>
      <p style={{ marginTop: 8, opacity: 0.75 }}>
    ...
    <p>
      None. Mineforge does not collect, store, or transmit any personal information — no names, email
      addresses, phone numbers, location, contacts, photos, or device identifiers of any kind.
    </p>

    <h3>2. Game Save Data</h3>
    <p>
      Your progress (current run, charms, satchel, best-run records, sound and language settings) is stored{' '}
    ...
    <p>
      Mineforge does not connect to the internet. It contains{' '}
    ...
    <div className="mf-wrap">
      <article className="mf-doc">
        <header className="mf-doc-head">
          ...
          <div className="mf-sub">{ko ? '개인정보 처리방침' : 'Privacy Policy'}</div>
