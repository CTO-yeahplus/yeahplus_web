...
// 여기서는 <html data-lang> 값만 관리한다 (sillok 과 같은 구조).
import { createContext, useContext, useEffect, useState } from 'react';

export type Lang = 'ko' | 'en';

export const STORAGE_KEY = 'steelstorm.site.lang';

export const NAV = {
  ko: { home: '홈', how: '플레이', specs: '사양', support: '지원', privacy: '개인정보', terms: '약관' },
  en: { home: 'Home', how: 'How to play', specs: 'Specs', support: 'Support', privacy: 'Privacy', terms: 'Terms' },
} as const;
