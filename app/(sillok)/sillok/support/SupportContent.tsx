      ...
      <div className="sl-wrap sl-doc">
        ...
        <section>
          ...
          <details>
            <summary>
              <span className="sl-q">
                진행 상황이 사라졌어요. 되돌릴 수 있나요?
                <span className="sl-q-en">My progress disappeared. Can it be restored?</span>
              </span>
            </summary>
          ...
          <details>
            <summary>
              <span className="sl-q">
                다른 기기에서 이어서 하고 싶습니다.
                <span className="sl-q-en">Can I continue on another device?</span>
              </span>
            </summary>
            <div className="sl-ans">
              <p>기기 사이 이어하기는 지원하지 않습니다. 계정과 서버가 없기 때문입니다. 개인정보를 전혀 받지 않기 위해 감수한 제약이며, 앞으로도 계정을 만들 계획은 없습니다.</p>
              <div className="sl-en">
                <p>No. Cross-device continuation would require an account and a server, and the app has neither. This is the trade-off we accepted in order to collect nothing, and we do not plan to add accounts.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                읽어주기 버튼을 눌러도 소리가 나지 않습니다.
                <span className="sl-q-en">Read-aloud makes no sound.</span>
              </span>
            </summary>
            <div className="sl-ans">
              <p>차례로 확인해 주세요.</p>
          ...
          <details>
            <summary>
              <span className="sl-q">
                글씨가 작아서 아이가 읽기 힘들어합니다.
                <span className="sl-q-en">The text is too small for my child.</span>
              </span>
            </summary>
            <div className="sl-ans">
              <p>앱 설정에서 글자 크기를 키울 수 있습니다. 본문은 기본값에서도 18pt 이상이며, 설정에서 더 크게 조절됩니다. 함께 읽어주기를 켜 두시면 아이가 눈으로 따라가면서 들을 수 있습니다.</p>
              <div className="sl-en">
                <p>Text size can be increased in the app's settings. Body text is 18pt or larger even at the default. Turning on read-aloud lets a child follow along by ear while reading.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                모르는 낱말이 나옵니다.
                <span className="sl-q-en">There are words my child does not know.</span>
              </span>
            </summary>
            <div className="sl-ans">
              <p>어려운 낱말에는 점선 밑줄이 그어져 있습니다. 그 낱말을 탭하면 초등학생이 이해할 수 있는 한 문장 설명이 말풍선으로 뜹니다. 179개 낱말이 등록되어 있고, 도감의 낱말 사전에서 전체를 훑어볼 수도 있습니다.</p>
              <div className="sl-en">
                <p>Difficult words carry a dotted underline; tapping one shows a single-sentence explanation written for this age. There are 179 entries, and the full list can be browsed in the codex.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                지표가 0이 되었습니다. 게임이 끝나나요?
                <span className="sl-q-en">A stat hit zero — is the game over?</span>
              </span>
            </summary>
            <div className="sl-ans">
              ...
              <div className="sl-en">
                <p>No. There is no game over. A matching crisis event is inserted and the next king starts from the minimum value. Joseon itself endured major wars and continued, so not ending on failure is the more accurate design.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                사초 조각이 잘 모이지 않습니다.
                <span className="sl-q-en">I am not collecting many record fragments.</span>
              </span>
            </summary>
            <div className="sl-ans">
              ...
              <div className="sl-en">
                <p>A fragment is awarded only when the choice matches what actually happened; otherwise the game shows the Joseon that might have been instead. To pick up a missed fragment, replay that king in Single King mode — it does not affect the main dynasty run.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                언어를 바꾸고 싶습니다.
                <span className="sl-q-en">How do I change the language?</span>
              </span>
            </summary>
            <div className="sl-ans">
              <p>제목 화면 오른쪽 위의 언어 버튼이나 설정에서 한국어와 영어를 전환할 수 있습니다. 바꾸어도 진행 상황은 그대로 유지됩니다.</p>
              <div className="sl-en">
                <p>Use the language button at the top right of the title screen, or the setting in Settings. Switching languages keeps your progress intact.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                부모 계정으로 사서 아이 기기에 설치하고 싶습니다 (가족 공유)
                <span className="sl-q-en">I bought it on my account — how do I install it on my child's device? (Family Sharing)</span>
              </span>
            </summary>
            <div className="sl-ans">
          ...
          <details>
            <summary>
              <span className="sl-q">
                광고나 추가 결제가 나오나요?
                <span className="sl-q-en">Are there ads or extra charges?</span>
              </span>
            </summary>
            <div className="sl-ans">
              <p>없습니다. 광고와 인앱결제를 넣지 않았습니다. 한 번 구매하시면 27명의 왕과 모든 도감이 열려 있고, 이후 청구되는 금액이 없습니다. 아이가 혼자 사용하다가 결제 화면을 만나는 일도 없습니다.</p>
              <div className="sl-en">
                <p>No. The app has no advertising and no in-app purchases. One purchase opens all 27 kings and the whole codex, and nothing is billed afterwards. A child using the app alone will never meet a payment screen.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                환불하고 싶습니다.
                <span className="sl-q-en">I would like a refund.</span>
              </span>
            </summary>
            <div className="sl-ans">
              ...
              <div className="sl-en">
                <p>Purchases are made through the App Store, so refunds follow the App Store's refund process. We never receive payment information and cannot issue refunds ourselves. If a problem with the app is the reason, please tell us first — it may be something we can fix.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                역사 서술이 잘못된 것 같습니다.
                <span className="sl-q-en">I think something in the history is wrong.</span>
              </span>
            </summary>
            <div className="sl-ans">
          ...
          <details>
            <summary>
              <span className="sl-q">
                수업이나 학급에서 써도 되나요?
                <span className="sl-q-en">May I use this in class?</span>
              </span>
            </summary>
            <div className="sl-ans">
              ...
              <div className="sl-en">
                <p>Please do. A single reign takes about five minutes, which fits several reigns into one lesson, and Single King mode lets you pick one king. Having two groups decide the same event differently and then reading the Annals Comparison together works well.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                인터넷 없이도 되나요?
                <span className="sl-q-en">Does it work without internet?</span>
              </span>
            </summary>
            <div className="sl-ans">
              <p>됩니다. 앱은 서버와 통신하지 않으며, 비행기 모드에서 처음부터 끝까지 동작합니다. 읽어주기도 기기에 내장된 음성을 쓰기 때문에 인터넷이 필요 없습니다.</p>
              <div className="sl-en">
                <p>Yes. The app never contacts a server and runs from start to finish in airplane mode. Read-aloud uses the device's built-in voice, so it needs no connection either.</p>
              </div>
            </div>
          </details>
          ...
          <details>
            <summary>
              <span className="sl-q">
                앱이 멈추거나 화면이 이상합니다.
                <span className="sl-q-en">The app froze or looks wrong.</span>
              </span>
            </summary>
            <div className="sl-ans">
              ...
              <div className="sl-en">
                <p>Quit the app fully and reopen it; progress is saved automatically. If it recurs, send your device model, iOS version and where it happened (which king, which event) to{' '}<a href="mailto:contact@yeahplus.co.kr">contact@yeahplus.co.kr</a>. Because the app collects nothing, your description is all we have to work from.</p>
              </div>
            </div>
          </details>
        </section>
