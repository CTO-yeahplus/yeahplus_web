...
export const dictionaries = {
  ko: {
    ...
    ecosystem: {
      ...
      sillok: { desc: "조선 27명의 왕이 되어 실록에 기록된 사건을 직접 결정합니다.", badges: ["실록 대조", "초등 3~6학년", "오프라인"] },
      steelstorm: { desc: "조준은 기체가, 판단은 당신이. 코어 컬러와 3단 변신의 아레나 슈터.", badges: ["코어 컬러", "3단 오버드라이브", "Game Center"] },
      cinelook: { desc: "주머니 속 네컷 사진관 — 셔터 한 번에 네 컷, 영화 필터와 프레임까지.", badges: ["4컷 부스", "영화 필터 35종", "프레임 20종"] },
      contraptionlab: { desc: "부품을 놓고 돌려 구슬을 바구니까지. 진짜 물리로 판정하는 퍼즐.", badges: ["48개 실험실", "레벨 에디터", "초등 1~6학년"] },
      faceroutine: { desc: "하루 5분, 카메라가 세어주는 얼굴 근육 코치.", badges: ["자동 횟수 세기", "기기 안 처리", "수집 없음"] },
      ...
      aceforge: { desc: "체인이 길수록 배율이 터지는 트라이픽스 솔리테어 로그라이크.", badges: ["카드 세공", "체인 배율", "덱 52장"] },
      mineforge: { desc: "옆칸을 이어 파면 광맥이 자라는 지뢰찾기 로그라이크.", badges: ["광맥 체인", "광석 매설", "첫 발굴 안전"] },
      jadeforge: { desc: "같은 문양을 이으면 맥이 자라는 마작 솔리테어 로그라이크.", badges: ["타일 세공", "맥 배율", "항상 클리어 가능"] },
      visit: "방문하기",
      soon: "준비 중",
    },
    architect: {
  ...
  en: {
    ...
    footer: {
      ...
      games: "Games",
      company: "Company",
      address: "3F 304-A318, 33 Gyoha-ro 159beon-gil, Paju-si, Gyeonggi-do, Korea",
    },
    ecosystem: {
      ...
      sillok: { desc: "Rule as each of Joseon's 27 kings and decide events the annals recorded.", badges: ["Annals Comparison", "Ages 9–12", "Offline"] },
      steelstorm: { desc: "The machine aims; you judge. An arena shooter of core colors and three-stage Overdrive.", badges: ["Core Color", "3-Stage Overdrive", "Game Center"] },
      cinelook: { desc: "A photo booth in your pocket — four shots from one tap, plus movie looks and frames.", badges: ["Photo Booth", "35 Movie Looks", "20 Frames"] },
      contraptionlab: { desc: "Drop a ramp, turn it, roll the marble home. Real physics decides.", badges: ["48 Labs", "Level Editor", "Grades 1-6"] },
      faceroutine: { desc: "Five minutes a day. The camera counts your facial muscle reps for you.", badges: ["Auto Rep Count", "On-Device", "No Tracking"] },
      ...
      aceforge: { desc: "TriPeaks solitaire where the longer the chain, the harder it detonates.", badges: ["Card Forging", "Chain Multiplier", "52-Card Deck"] },
      mineforge: { desc: "Minesweeper where chaining adjacent digs grows a scoring seam.", badges: ["Seam Chains", "Buried Ore", "First Dig Safe"] },
      jadeforge: { desc: "Mahjong solitaire where matching a suit grows your vein.", badges: ["Tile Carving", "Vein Multiplier", "Always Solvable"] },
      visit: "Visit",
      soon: "Coming Soon",
    },
    architect: {
