...
export const dictionaries = {
  ko: {
    ...
    ecosystem: {
      ...
      cinelook: { desc: "필름카메라 감성부터 영화의 한 장면까지, 탭 한 번으로.", badges: ["필름카메라 8종", "영화 필터 30종", "4컷 부스"] },
  ...
  en: {
    ...
    ecosystem: {
      ...
      cinelook: { desc: "From old digicam vibes to a scene from a movie, in a single tap.", badges: ["8 Film Cameras", "30 Movie Filters", "Four-Shot Booth"] },
